...
#define END(a)    ;
#define ENTRY(a)  .type a, %function; a:;
        .set $C0_INDEX, $0
        .set $C0_RANDOM, $1
        .set $C0_ENTRYL0, $2
        .set $C0_ENTRYL1, $3
        ...
        .set MC_CSR,                  0xB82F4008
            .set FLUSH_I,             0x1000
            .set FLUSH_D,             0x4000
            .set TR_CRAM,             0x2
        .set MC_MASKR0,               0xB82F4010	
        .set MC_QSTR0,                0xB82F4014	                                               
        .set MC_MASKR1,               0xB82F4018	
        .set MC_QSTR1,                0xB82F401C	
        .set MC_MASKR2,               0xB82F4020	
        .set MC_QSTR2,                0xB82F4024	
        .set MC_MASKR3,               0xB82F4028	
        .set MC_QSTR3,                0xB82F402c	
        .set MC_IRQM,                 0xB82F4030
    
        .set MC_DMA_MEM_BASE,         0xB82F0000
        .set MC_CSR_EXT,              0xB82F1024
#RTOS
        .set NEED_NONE, 0
        .set NEED_SLEEP, 1
        .set NEED_PAUSE, 2
        .set NEED_RESUME, 3
        .set NEED_DISABLE_IRQ, 4
        .set NEED_ENABLE_IRQ, 5
        .set NEED_EXIT, 6
